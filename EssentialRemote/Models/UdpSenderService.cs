...
namespace EssentialRemote.Models
{
    public class UdpSenderService
    {
        ...
        private readonly string _targetIpAddress = "127.0.0.1"; // PC ip -adresse, hvor Python-scriptet kører, lige pt. hente det påny med hostname -I kommandoen i terminalen på PC'en, emulator: 10.0.2.2
